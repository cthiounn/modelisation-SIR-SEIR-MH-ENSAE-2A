...
plot_simulation_graph=function(simulation_dataframe){
  ...
  ggplot2::ggplot(data=df) + ggplot2::geom_line(data=df_simul,mapping = ggplot2::aes(x, y ,colour = type)) +ggplot2::geom_point(data=df_observed,mapping = ggplot2::aes(x, y ,colour = type))+ ggplot2::xlab("nombre de jours") +ggplot2::ylab("nombre d'infectés")
} 
...
representerMH_beta_distrib<-function(resultats_parametres,nombre_iteration_burnIn){
  ...
  hist(distribution_simulee_beta, main="Posterior de Beta", xlab="Valeur de Beta", ylab="Nombre d'occurrence" )
...
representerMH_gamma_distrib<-function(resultats_parametres,nombre_iteration_burnIn){
  ...
  hist(distributation_simulee_gamma, main="Posterior de Gamma", xlab="Valeur de Gamma", ylab="Nombre d'occurrence")
...
plot_simulation_graph_SIR_SEIR=function(simulation_dataframe_SIR,simulation_dataframe_SEIR){
    ...
    ggplot2::ggplot(data=df)  + ggplot2::geom_line(data=df_simul_sir,mapping = ggplot2::aes(x, y ,colour = type)) + ggplot2::geom_line(data=df_simul_seir,mapping = ggplot2::aes(x, y ,colour = type)) +ggplot2::geom_point(data=df_observed,mapping = ggplot2::aes(x, y ,colour = type))+ ggplot2::xlab("nombre de jours") +ggplot2::ylab("nombre d'infectés")
}